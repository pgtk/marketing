...
type
  TStudentsListReportForm = class(TForm)
    ...
    procedure CourseLabelPrint(sender: TObject; var Value: String);
    procedure QRLabel9Print(sender: TObject; var Value: String);
    procedure QRLabel12Print(sender: TObject; var Value: String);
    procedure WorkLabelPrint(sender: TObject; var Value: String);
  private
...
procedure TStudentsListReportForm.CourseLabelPrint(sender: TObject;
  var Value: String);
begin
Value := #$D+Value;
end;
...
procedure TStudentsListReportForm.QRLabel12Print(sender: TObject;
  var Value: String);
begin
Value := IntToStr(MainForm.FStudentsQuery.RecNo);
end;

procedure TStudentsListReportForm.WorkLabelPrint(sender: TObject;
  var Value: String);
begin
Value := '';
end;
